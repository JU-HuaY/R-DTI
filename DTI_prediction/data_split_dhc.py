...
def split(dir_input, input_file):
    ...
    dataset = shuffle_dataset(dataset, 1000)
...
# split("datasets/Drugbank/data_split/", "datasets/Drugbank")
# split("datasets/human/data_split/", "datasets/human")
# split("datasets/celegans/data_split/", "datasets/celegans")
split("datasets/Davis/data_split/", "datasets/Davis/split2")
# split("datasets/KIBA/data_split/", "datasets/KIBA/split2")
