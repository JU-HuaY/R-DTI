...
def DTI_datasets(dataset, dir_input, LM_dic):  # BindingDB, Human, C.elegan, GPCRs
...
def DTI_drugbank_datasets(dataset, dir_input, LM_dic):  # DrugBank
...
def DTA_datasets(dataset, dir_input, LM_dic): # Davis, Kiba
    with open(LM_dic, 'rb') as p:
        pro_LM = pickle.load(p)
...
if __name__ == "__main__":
    ...
    # DTI_datasets("datasets/BindingDB/original/train.txt", 'datasets/BindingDB/train/', 'datasets/BindingDB/p_LM.pkl')
    # DTI_datasets("datasets/BindingDB/original/dev.txt", 'datasets/BindingDB/validation/', 'datasets/BindingDB/p_LM.pkl')
    # DTI_datasets("datasets/BindingDB/original/test.txt", 'datasets/BindingDB/test/', 'datasets/BindingDB/p_LM.pkl')

    # DTI_datasets("datasets/human/original/data.txt", 'datasets/human/data_split/',
    #              'datasets/human/p_LM.pkl')
    # DTI_datasets("datasets/celegans/original/data.txt", 'datasets/celegans/data_split/',
    #              'datasets/celegans/p_LM.pkl')
    # DTI_drugbank_datasets("datasets/Drugbank/original/data.txt", 'datasets/Drugbank/data_split/',
    #              'datasets/Drugbank/p_LM.pkl')
    # DTA_datasets("datasets/Davis/original/Davis_DTA.txt", 'datasets/Davis/data_split/', 'datasets/Davis/p_LM.pkl')
    DTA_datasets("datasets/KIBA/original/KIBA_DTA.txt", 'datasets/KIBA/data_split/', 'datasets/KIBA/p_LM.pkl')
